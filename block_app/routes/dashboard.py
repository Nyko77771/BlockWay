...
def home():
    ...
    try:
        ...
        if check_user_type(user_id):
            ...
            return render_template('admin_templates/dashboard_templates/admin_system_details.html', current_user=user)
...
def threats():
    return render_template('normal_templates/dashboard_templates/threats.html', current_user=user)
...
def configurations():
    return render_template('normal_templates/dashboard_templates/admin_configurations.html')
